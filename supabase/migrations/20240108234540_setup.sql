...
AS $$
DECLARE
  project_url TEXT := 'https://swxflysmwaxncawvlgik.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN3eGZseXNtd2F4bmNhd3ZsZ2lrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MzY0MjE0NywiZXhwIjoyMDU5MjE4MTQ3fQ.fBQuSTb1zno0XxfW1H0unBP9ZoXd14-Dy87feObEPi8'; -- full access needed for http request to storage
